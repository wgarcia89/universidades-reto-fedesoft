...
class UniversidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create universidad" do
    assert_difference('Universidad.count') do
      post universidades_url, params: { universidad: { email: @universidad.email, localidad_id: @universidad.localidad_id, nombre: @universidad.nombre, reponsable: @universidad.reponsable } }
    end
  ...
  test "should update universidad" do
    patch universidad_url(@universidad), params: { universidad: { email: @universidad.email, localidad_id: @universidad.localidad_id, nombre: @universidad.nombre, reponsable: @universidad.reponsable } }
